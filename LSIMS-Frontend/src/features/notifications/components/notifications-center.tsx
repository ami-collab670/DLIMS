...
import { canManageJobsAndSamples, isReceptionist } from "@/lib/staff";
import { RECEPTIONIST_MESSAGE_TEMPLATES } from "@/lib/staff/receptionist/message-templates";
...
function NotificationListItem({
  ...
  const detailQuery = useNotificationDetail(notification.id, {
    enabled: expanded,
  });
...
export function NotificationsCenter({
  ...
  const markAllUnreadMut = useMarkAllNotificationsUnread();
