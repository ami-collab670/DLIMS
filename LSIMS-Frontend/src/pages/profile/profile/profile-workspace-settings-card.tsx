...
/**
 * Local workspace preferences: theme, session, API docs.
 * Not persisted via the profile API.
 */
export function ProfileWorkspaceSettingsCard() {
  ...
  return (
    ...
    >
      <h3 id="workspace-settings-heading" className="text-sm font-medium">
        Workspace settings
      </h3>
      <p className="mt-1 text-xs text-muted-foreground">
        Appearance and session controls are stored in this app only. Sign out clears JWT
        tokens locally.
      </p>
